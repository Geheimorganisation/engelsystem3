...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShiftLocation.color'
        db.add_column('angelsystem_shiftlocation', 'color',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShiftLocation.color'
        db.delete_column('angelsystem_shiftlocation', 'color')
